...
timeout 15
CSTART "" %SPARK_HOME%\bin\spark-submit --master local[4] --packages org.apache.spark:spark-streaming-kafka-0-8_2.11:2.0.0 C:\Users\prath\PycharmProjects\Real-Time-Sentiment-Analysis\tweet_spark_consumer.py
timeout 10
